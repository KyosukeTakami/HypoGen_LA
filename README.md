...
The public repository contains the hypothesis-generation and fine-tuning resources associated with the study. Participant-level human evaluation data are not included in this repository.
